...
def triang_plot(linewid):
    ...
    for i in range(iter_num):
        ...
        plt.plot(x, y, color=colormap(1-(0.0055-0.0005*((1/((0.75)+1))))*i),linewidth=linewid)
    ...
    for dset in range(1,10,1):
        ...
        for triang in range(3):
            ...
            for i in range(iter_num):
                ...
                plt.plot(x, y,color=colormap((1.05-0.055*triang-(0.0055-0.0005*((1/((scale)+1))))*i-0.1*scale)),linewidth=linewid*delta**scale)
...
plt.savefig('/Users/henryschnieders/Desktop/proj/Designs/Releases/June 2024/triangles/Images/Mult/cool_separate_lines_highcolorchange_figsize.png', transparent=True, dpi=2700)