    ...
    for dset in range(1,10,1):
        ...
        for triang in range(3):
            for i in range(iter_num):
                ...
                plt.plot(x, y,color=colormap((0.895-0.055*triang-(0.00105-0.0005*((1/((scale)+1))))*i-0.1*scale)),linewidth=linewid)
...
triang_plot(0.475)
plt.savefig('/Users/henryschnieders/Desktop/proj/Designs/Releases/June 2024/triangles/Images/Mult/cool_smooth.png', transparent=True, dpi=1200)