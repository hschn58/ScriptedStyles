...
#for top and bottom, order is reversed for one of them (pts[-1] is plotted at pts[0]) for desired effect.
    ...
    for p in range(pts):
        ...
        #red
        plt.plot(xdata1_ptsb2[p][l],ydata1_ptsb2[p][l], color=colormap2(color_func2(l,p,pts)), linewidth=0.5)
    ...
    for p in range(pts):
        ...
        #red
        plt.plot(xdata2_ptsb2[p][l],ydata2_ptsb2[p][l], color=colormap2(color_func2(l,pts-p-1,pts)), linewidth=0.5)
