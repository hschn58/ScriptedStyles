...
#for top and bottom, order is reversed for one of them (pts[-1] is plotted at pts[0]) for desired effect.
    ...
    for p in range(pts):
        ...
        plt.plot(xdata1_ptsb1[p][l],ydata1_ptsb1[p][l], color=colormap1(color_func(l,p,lines,pts)), linewidth=0.5)
        
        #red
        plt.plot(xdata1_ptsb2[p][l],ydata1_ptsb2[p][l], color=colormap2(color_func(lines-l-1,p,lines,pts)), linewidth=0.5)
        
    #top
    for p in range(pts):
        
        #blue
        plt.plot(xdata2_ptsb1[p][l],ydata2_ptsb1[p][l], color=colormap1(color_func(l,pts-p-1,lines,pts)), linewidth=0.5)
        
        #red
        plt.plot(xdata2_ptsb2[p][l],ydata2_ptsb2[p][l], color=colormap2(color_func(lines-1-l,pts-p-1,lines,pts)), linewidth=0.5)
