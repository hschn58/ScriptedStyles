...
axis_image1 = render_quilt_image(colormap=final_cmap, seed=2183, dpi=dpi)
...
filename = unique_filename( os.path.join(dirname, 'fun_quilt.png'))
# Display or save
