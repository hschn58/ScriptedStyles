...
plt.savefig('/Users/henryschnieders/Desktop/proj/Designs/Releases/June 2024/Random Walks/Results/No sum/binary_02__vlarge_5.png',transparent=True, dpi=7200)
#plt.show()